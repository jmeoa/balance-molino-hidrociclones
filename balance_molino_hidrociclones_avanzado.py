...
fig.add_annotation(x=0.24, y=0.45, text=f"{P:.1f} t/h<br>{porc_solidos_molino:.1f}% sólidos<br>{agua_adicional:.1f} m³/h", showarrow=False, font=dict(size=14, color="black"))
fig.add_annotation(x=0.65, y=0.28, text=f"{U:.1f} t/h<br>{porc_solidos_uf:.1f}%<br>{agua_underflow:.1f} m³/h", showarrow=False, font=dict(size=14, color="black"))
fig.add_annotation(x=0.85, y=0.72, text=f"{O:.1f} t/h<br>{porc_solidos_of:.1f}%<br>{agua_overflow:.1f} m³/h", showarrow=False, font=dict(size=14, color="black"))
